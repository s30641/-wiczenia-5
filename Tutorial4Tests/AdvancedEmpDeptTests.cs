    ...
    public class AdvancedEmpDeptTests
    {
        ...
        public void ShouldReturnEmployeeManagerPairs()
        {
            ...
            var result = (from e in emps
                          join m in emps on e.Mgr equals m.EmpNo
        ...
        {
            var emps = Database.GetEmps();
            var result = emps.Select(e => new { e.EName, Total = e.Sal + (e.Comm ?? 0) })
                             .ToList();
        ...
        // SQL: SELECT E.EName, D.DName, S.Grade FROM Emp E 
        ...
        public void ShouldJoinEmpDeptSalgrade()
        {
            ...
            var result = (from e in emps
                          ...
                          select new { e.EName, DName = d.DName, s.Grade })
                          .ToList();
