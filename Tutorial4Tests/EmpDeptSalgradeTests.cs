...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Emp> result = emps.Where(e => chicagoDepts.Contains(e.DeptNo)).ToList(); 
    ...
    public void ShouldJoinEmployeesWithDepartments()
    {
        ...
        var result = (from e in emps
                      ...
                      select new { e.EName, d.DName }).ToList(); 
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        List<Emp> result = emps.Where(e => e.Comm != null).ToList(); 
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = (from e in emps
                      ...
                      select new { e.EName, Grade = s.Grade }).ToList(); 
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        List<string> result = emps.Where(e => e.Sal > emps.Where(x => x.DeptNo == e.DeptNo).Average(x => x.Sal))
                                   .Select(e => e.EName)
                                   .ToList(); 
